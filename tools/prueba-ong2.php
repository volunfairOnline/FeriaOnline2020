<?php
	...
	$enlace = mysqli_connect($servidor, $usuario, $clave, $baseDeongs);	
					...
					<div class="row">
							<div class="col-md-6 colum">
								...
								<div class="form-group m-checkbox step__input">
									 <input type="checkbox" id="proyecto1" name="proyecto[]" value="1"><label for="proyecto1">&nbsp; Ancianos</label><br>
									 <input type="checkbox" id="proyecto2" name="proyecto[]" value="2"><label for="proyecto2">&nbsp; Sin recursos</label><br>
									 ...
									 <input type="checkbox" id="proyecto5" name="proyecto[]" value="5"><label for="proyecto5">&nbsp; Misión</label><br>
									 <input type="checkbox" id="proyecto6" name="proyecto[]" value="6"><label for="proyecto6">&nbsp; Niños</label><br>
									 <input type="checkbox" id="proyecto7" name="proyecto[]" value="7"><label for="proyecto7">&nbsp; Discapacitados</label><br>
									 <input type="checkbox" id="proyecto8" name="proyecto[]" value="8"><label for="proyecto8">&nbsp; Animales</label><br>
									 <input type="checkbox" id="proyecto9" name="proyecto[]" value="9"><label for="proyecto9">&nbsp; Proyecto científico</label><br>
									 <input type="checkbox" id="proyecto10" name="proyecto[]" value="10"><label for="proyecto10">&nbsp; Otros</label><br>			  				
								</div>
							</div>
							<div class="col-md-6 colum">
								...
								<div class="form-group m-checkbox step__input">
								  ...
								  <input type="checkbox" id="lugar2" name="lugar[]" value="2"><label for="lugar2">&nbsp; Asia</label><br>
								  <input type="checkbox" id="lugar3" name="lugar[]" value="3"><label for="lugar3">&nbsp; Oceanía</label><br>
								  <input type="checkbox" id="lugar4" name="lugar[]" value="4"><label for="lugar4">&nbsp; América del Sur</label><br>
								  <input type="checkbox" id="lugar5" name="lugar[]" value="5"><label for="lugar5">&nbsp; Centroamérica</label><br>
								  <input type="checkbox" id="lugar6" name="lugar[]" value="6"><label for="lugar6">&nbsp; América del norte</label><br>
								  <input type="checkbox" id="lugar7" name="lugar[]" value="7"><label for="lugar7">&nbsp; África</label><br>
								  <input type="checkbox" id="lugar8" name="lugar[]" value="8"><label for="lugar8">&nbsp; Madrid</label><br>
								  <input type="checkbox" id="lugar9" name="lugar[]" value="9"><label for="lugar9">&nbsp; Europa</label><br>
...
<?php
	...
	$ejecutarInsertar = mysqli_query($enlace, $insertarongs);
	...
	if(!empty($_POST['nombreImagen']))
	{
		...
		{			
			...
			mysqli_query($enlace, "UPDATE imagen SET nombre_img='$nombreImagen' WHERE id_img='$id_maximo'");
			mysqli_query($enlace, "UPDATE ongs SET logo_ong='$id_maximo' WHERE id_ong='$id_insertado'");
			echo '<script type="text/javascript">alert("Se ha actualizado la información con éxito")</script>';
		}else{
			$sql=mysqli_query($enlace, "SELECT id_img FROM imagen WHERE nombre_img='$nombreImagen'");			
			if($row=mysqli_fetch_array($sql))
			{
				echo '<script type="text/javascript">alert("No se permiten datos duplicados en la base de datos")</script>';
				
			}else{
				mysqli_query($enlace, "INSERT INTO imagen (nombre_img, id_ong) VALUES ('$nombreImagen', '$id_insertado')");				
				$ss=mysqli_query($enlace, "SELECT MAX(id_img) as id_maximo FROM imagen");
		...
		mysqli_query($enlace, "UPDATE ongs SET direccion_ong='$location' WHERE id_ong='$id_insertado'");		
	...
	foreach($_POST['proyecto'] as $id_proyecto)
	{
		...
		mysqli_query($enlace, $insertarongs2);
	}	
	...
	foreach($_POST['lugar'] as $id_voluntariado)
	{
		...
		mysqli_query($enlace, $insertarongs3);
	}	
