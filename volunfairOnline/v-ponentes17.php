...
?>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="c-content-media-1 c-bordered wow animated fadeInLeft" style="min-height: 300px; background-color: #e8ebeb;">
                                ...
                                <p class="c-right">
                                En las ponencias de la feria de 2017 tuvimos el honor de contar con el carismático locutor de radio, Javi Nieves, para que 
                                realizara una primera presentación de los invitados. Conocido por su trabajo en la emisora "Cadena-100", cuenta con un 
                                Premio Ondas al mejor presentador de radio musical.
                                </p>
                            </div>
                        </div>
                    	   <div class="col-md-4">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="c-content-media-1 c-bordered wow animated fadeInRight" style="min-height: 300px; background-color: #e8ebeb;">
                                <div class="c-content-title-3 c-theme-border ">
                                   <h3 class="c-font-uppercase c-font-bold">Rolando Ruiz Durán</h3>
                                   <div class=" c-line-left "></div>
                                 </div>
        ...
        <!-- https://web.archive.org/web/20170601041218/http://www.volunfair.com:80/-->
