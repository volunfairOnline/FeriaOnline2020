...
?>
        ...
        <div class="c-layout-page">
			...
			<div class="c-layout-breadcrumbs-1 c-bgimage c-subtitle c-fonts-uppercase c-fonts-bold c-bg-img-center" style="background-image: url(assets/base/img/volunfair/mares/mar_008.jpg)">
                 <!--<div class="container">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-4 wow animated fadeInDown">
							<img src="./assets/base/img/volunfair/premio/premioVicente&Xabi.jpg" width="100%" alt="Vicente del Bosue y Xabi Torres reciben el Premio en 2019" />
							<br /><br />
							<img src="./assets/base/img/volunfair/premio/premioPacoArango.jpg" width="100%" alt="Paco Arango recibe el Premio en 2018" />
						</div>
